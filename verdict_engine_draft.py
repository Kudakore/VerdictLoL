"""
Draft Engine - Verdict Engine Architecture
...
def run_draft_engine(games=None, player_id=None, cache_path=None) -> Optional[EngineOutput]:
    ...
    return run_engine_from_cache(DraftEngine, cache_path, games=games, player_id=player_id)
