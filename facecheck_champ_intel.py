"""
FaceCheck Champion Intelligence Layer
...
def print_counter_command(enemy_champion, game_history=None):
    """Full output for facecheck counter [champion]."""
    ...
    print(f"\n  {'='*62}")
    print(f"  FACECHECK COUNTER — {enemy_champion}")
    print(f"  {'='*62}")
...
def print_intel_profile(champion_name):
    """Full intel profile for a champion — facecheck intel [champion]."""
